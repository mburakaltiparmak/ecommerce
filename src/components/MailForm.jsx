export const MailForm = () => {
  return (
    <div className="relative flex flex-wrap">
      <input
        type="email"
        className="relative m-0 -mr-0.5 block w-[1px] px-20 min-w-0 flex-auto rounded-l border border-solid border-neutral-300 bg-transparent bg-clip-padding py-2 text-base font-xl leading-[1.6] text-black outline-none transition duration-200 ease-in-out "
